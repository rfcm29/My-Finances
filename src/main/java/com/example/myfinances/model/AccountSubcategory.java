...
@Entity
@Table(name = "t_cat_account_subs")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(exclude = {"category", "accounts"})
@ToString(exclude = {"category", "accounts"})
public class AccountSubcategory {
    ...
    @NotBlank(message = "Código da subcategoria é obrigatório")
    ...
    public AccountSubcategory(String code, String name, String description, AccountCategory category) {
        this.code = code;
        this.name = name;
