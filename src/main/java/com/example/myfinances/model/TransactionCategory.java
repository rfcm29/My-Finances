...
public class TransactionCategory {
    ...
    public TransactionCategory(User user, String name, CategoryType type) {
        this.user = user;
        this.name = name;
        this.type = type;
    }
    
    public TransactionCategory(User user, String name, CategoryType type, String color, String icon) {
        this.user = user;
        this.name = name;
        this.type = type;
        this.color = color;
